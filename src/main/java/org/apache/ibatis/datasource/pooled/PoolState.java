...
public class PoolState {
    ...
    protected long accumulatedRequestTime = 0;  // 获取连接累计时间
    /**
     * checkoutTime: 当连接从池中取出，到归还这段时间
     */
    protected long accumulatedCheckoutTime = 0;
    protected long claimedOverdueConnectionCount = 0;   // 当长时间未归还，则任务连接超时，这里记录超时连接个数
