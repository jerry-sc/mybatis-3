...
public class TypeParameterResolver {
    ...
    public static Type resolveFieldType(Field field, Type srcType) {
        Type fieldType = field.getGenericType();    // 得到泛型类型，getType方法则返回普通的声明类型
        Class<?> declaringClass = field.getDeclaringClass();    // 得到该变量所在的类
    ...
    /**
     * 根据type的真实类型，选择合适的方法进行解析
     * @param type
     * @param srcType
     * @param declaringClass 该字段方法所在的类
     * @return
     */
